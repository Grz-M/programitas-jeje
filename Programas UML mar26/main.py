...
#Pruebas de métodos de las clases
peli = Pelicula("Dune: Part Two", 166, "B", "Sci-Fi")
sala_vuelo = Sala(201, "Sala IMAX 1", "Planta Alta", 120, True, Tipo.IMAX)
admin = Empleado("E001", "Carlos Ruiz", "carlos@cine.com", "555-101", "08:00-16:00", Rol.ADMIN)

print("PRUEBA: GESTIÓN DE FUNCIONES")
funcion_noche = Funcion(1001, peli, sala_vuelo, "2026-03-05 20:00", 180.0)
funcion_noche.obtenerDetallesFuncion()

print("\nPRUEBA: CREACIÓN DE RESERVA")
cliente = Usuario(501, "Juan Nieves", "juan@mail.com", "555-201")
cliente.login()
asientos = ["A1", "A2"]
cliente.crearReserva(peli.titulo, asientos)
reserva_juan = Reserva("R001", cliente, funcion_noche, asientos, 360.0, Estado.PENDIENTE)

print("\nPRUEBA: PROMOCIÓN Y PAGO")
promo_estu = Promocion("ESTU20", "20% Estudiantes", 20.0, "2026-12-31")

if promo_estu.esValida(cliente):
    reserva_juan.aplicarPromocion(promo_estu)

reserva_juan.confirmarPago()
reserva_juan.generarTicket()

print("\nPRUEBA: DISPONIBILIDAD Y LIMPIEZA")
sala_vuelo.verificarDisponibilidad()
sala_vuelo.limpiarEspacio()

print("\nPRUEBA: ZONA DE COMIDA")
dulceria = ZonaComida(301, "Dulcería Principal", "Lobby")
dulceria.actualizarInventario("Palomitas Grandes", 50)
dulceria.venderProducto("Palomitas Grandes", 2)